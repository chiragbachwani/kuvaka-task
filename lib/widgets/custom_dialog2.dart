                  ...
                  children: [
                    ...
                    _buildContainer(
                      ...
                      additionalContent: Column(
                        ...
                        children: [
                          const Text('Food delivered to?\nCustomer Name', style:TextStyle(color: Color(0xFF413F3F), fontSize: 14, fontFamily: 'inter', fontWeight: FontWeight.w500) ,),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children:  [
                             Text('+44 1234567890', style: TextStyle(color: const Color(0xFF413F3F), fontSize:  MediaQuery.of(context).size.width*0.03, fontFamily: 'inter', fontWeight: FontWeight.w500),),
                             ElevatedButton(
                            onPressed: () {},
                            ...
                            child:  Text('Call Restaurant', style: TextStyle(color: Colors.white, fontSize: MediaQuery.of(context).size.width*0.02, fontFamily: 'inter'),),
                          ),
                      ...
                      additionalContent: Column(
                        children:  [
                          ...
                          ElevatedButton(
                            ...
                            child: const Text('Go Back', style: TextStyle(color: Colors.white, fontSize: 12, fontFamily: 'inter'),),
                          ),
                        ],
                      ),
                    ),
